    ...
    override async run(ctx: CommandContext) {
        const components = new Container().setColor(ctx.client.config.colors.enderbotColor).addComponents(
            new Section()
                ...
                .setAccessory(
                    new Thumbnail().setMedia(ctx.client.me.avatarURL({ forceStatic: true, size: 64 }) as string)
                ),
            ...
            new Section()
                ...
                .setAccessory(
                    new Button()
                        ...
                        .setLabel("enderdev-v github")
                        .setURL("https://github.com/enderdev-v/"),
                ),
            new Section()
